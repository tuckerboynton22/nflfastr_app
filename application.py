...
def index():
    ...
    # Provide search results
        ...
        if group == "name":
            grouping = group + ", id"
            grouping_null = " AND " + group + " IS NOT NULL " + " AND DATALENGTH(CAST(" + group + " AS TEXT))>0 "
        ...
        if group2 == "name":
            ...
            grouping_null = grouping_null + " AND " + group2 + " IS NOT NULL " + " AND DATALENGTH(CAST(" + group2 + " AS TEXT))>0 "
